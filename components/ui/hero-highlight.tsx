...
import { generateGradientClassUnified } from "@/utils";
...
export const Highlight = ({
  ...
  const gradientClass = generateGradientClassUnified(gradient);
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg px-1 pb-1 bg-gradient-to-r`,
        gradientClass,
        className,
      )}
    >
